 ...
 * Template files can reside in the parent or current theme, the CVincent::ThemeEngineRender()
 ...
 *
 * path: Path to current theme, relativly VINCENT_INSTALL_PATH, for example themes/grid or site/themes/mytheme.
...
$wi->config['theme'] = array(
	...
	//'path'            => 'themes/grid',
	'parent'			=> 'themes/grid',
  	'stylesheet'		=> 'style.css',  // main stylsheet to include in template files
