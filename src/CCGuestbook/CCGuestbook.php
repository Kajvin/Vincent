...
class CCGuestbook extends CObject implements IController, IHasSQL {
  ...
  private $pageTitle = 'Vincent Guestbook Example';
  private $pageHeader = '<h1>Guestbook Example</h1><p>Showing off how to implement a guestbook in Vincent. Now saving to database.</p>';
