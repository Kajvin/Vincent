...
class CMModules extends CObject {
   ...
   * Properties
   */
  private $lydiaCoreModules = array('CVincent', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
  ...
  private function GetDetailsOfModule($module) {
    ...
    if(class_exists($module)) {
      ...
      $details['isVincentCore']   = in_array($rc->name, $this->lydiaCoreModules);
      $details['isVincentCMF']    = in_array($rc->name, $this->lydiaCMFModules);
